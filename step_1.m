...
plot(1:length(dsc.data),dsc.data,'b',1:N_t_sorted(3),dsc.data(1:N_t_sorted(3)),'r',1:N_t_sorted(2),dsc.data(1:N_t_sorted(2)),'g',1:N_t_sorted(1),dsc.data(1:N_t_sorted(1)),'m');
...
x_values = [N_t_sorted(1)*(1 - 2*sigma_f); N_t_sorted(1)*(1 + 2*sigma_f); N_t_sorted(1)*(1 + 2*sigma_f); N_t_sorted(1)*(1 - 2*sigma_f)];
y_values = [min(dsc.data) - 10; min(dsc.data) - 10; max(dsc.data) + 10; max(dsc.data) + 10];
color_fill = 'magenta';
fill(x_values,y_values,color_fill);

x_values = [N_t_sorted(2)*(1 - 2*sigma_f); N_t_sorted(2)*(1 + 2*sigma_f); N_t_sorted(2)*(1 + 2*sigma_f); N_t_sorted(2)*(1 - 2*sigma_f)];
y_values = [min(dsc.data) - 10; min(dsc.data) - 10; max(dsc.data) + 10; max(dsc.data) + 10];
color_fill = 'green';
fill(x_values,y_values,color_fill);

x_values = [N_t_sorted(3)*(1 - 2*sigma_f); N_t_sorted(3)*(1 + 2*sigma_f); N_t_sorted(3)*(1 + 2*sigma_f); N_t_sorted(3)*(1 - 2*sigma_f)];
y_values = [min(dsc.data) - 10; min(dsc.data) - 10; max(dsc.data) + 10; max(dsc.data) + 10];
color_fill = 'red';
fill(x_values,y_values,color_fill);

x_values = [1; N_t_sorted(1); N_t_sorted(1);1];
y_values = [-20; -20; -15; -15];
color_fill = 'magenta';
fill(x_values,y_values,color_fill);

x_values = [1; N_t_sorted(2); N_t_sorted(2);1];
y_values = [-25; -25; -20; -20];
color_fill = 'green';
fill(x_values,y_values,color_fill);

x_values = [1; N_t_sorted(3); N_t_sorted(3);1];
y_values = [-30; -30; -25; -25];
color_fill = 'red';
fill(x_values,y_values,color_fill);
