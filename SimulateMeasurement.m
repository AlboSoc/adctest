...
uimenu(hMenuSimulationHelp,'Label','How to simulate measurement','Callback',@HelpHowToSimulate_callback);
    ...
    function HelpHowToSimulate_callback(source,eventdata)
        helpdlg({'To perform simulations please note the following:';...
                 ...
                 'and also can be described with the initial phase (in degrees), and the amplitude of the sine wave.';...
                 'Note that the Full Scale of the converter is normalized to 1, and amplitude is halfe';...
                 ...
                 'Std of noise is the standard deviation of noise in the excitation signal';...
