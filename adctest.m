function adctest
% @fn adctest
% @brief Main function of ADCTest toolbox. Implements the Main Window of
...
hTextFrameMeasurementInformation = uicontrol ('Style','text',...
                                         ...
                                         'BackgroundColor',[0.8 0.8 0.8],...
                                         'String','Measurement information');
...
uimenu(hMenuADCTestHelp,'Label','What is new in version 4.6','Callback',@HelpWhatsNew_callback);
...
UpdateDisplay;
    ...
    function HelpWhatsNew_callback(source,eventdata)
        helpdlg({'Version 4.6 contains minor changes and compared to version 4.5.';...
                 'Some minor bugs have been fixed regarding';...
                 'approximate maximum likelihood (AML) estimation';...
                 'of quantizer and excitation signal parameters.' ;...
                 'The notation has been unified as well'
                 '                                             ';...
                 'v4.5:';...
                 'The main new feature of version 4.5';...
                 'is the approximate maximum likelihood (AML) estimation';...
                 'of quantizer and excitation signal parameters.';...
                 'This method parameterizes the integral nonlinearity of the';...
                 'quantizer under test and optimizes the ML cost function';...
                 'with respect to the parameters of the excitation signal and';...
                 'the parameters of the quantizer nonlinearity as well.'});
    end
